            ...
            <div className="block lg:hidden p-6 md:p-8 space-y-6 bg-gradient-to-br from-[#f6c453] to-[#f0a04b] animate-heartbeat">
              ...
              <div className="flex justify-center">
                <div className="relative">
                  ...
                  {/* Decorative Elements */}
                  <div className="absolute -top-2 -right-2 w-5 h-5 bg-[#f6c453] rounded-full flex items-center justify-center">
                    <div className="w-2 h-2 bg-[#f6c453] rounded-full"></div>
                  </div>
                  <div className="absolute -bottom-2 -left-2 w-4 h-4 bg-[#0b4d59] rounded-full animate-pulse"></div>
                </div>
              </div>
            ...
            >
              ...
              <div className="aspect-video bg-gradient-to-br from-[#f6c453]/10 to-[#f0a04b]/10 relative overflow-hidden rounded-t-2xl rounded-b-none">
                ...
                <div className="absolute inset-0 w-full h-full">
                  <SpotifyEpisodeDisplay 
                    episodeUrl="https://open.spotify.com/episode/57gSexp1QP0yt4zpi0CYAH?si=iIBEFrhOTDO49b95L3pMXg"
                    className="w-full h-full"
                    rounded={false}
                    showBorder={false}
                  />
